...
```{r simulate_time, fig.width=10, fig.height=5}
N <- 350; T <- 1095; S <- 0.5
...
```{r simulate_n, echo=FALSE, fig.width=10, fig.height=5}
N <- 350; T <- 1095; S <- 0.5
...
```{r simulate_n_and_time, echo=FALSE, fig.width=10, fig.height=5}
N <- 350; T <- 1095; S <- 0.5
...
```{r simulate_cost, echo=FALSE, fig.width=10, fig.height=5}
N <- 350; T <- 1095; S <- 0.5
