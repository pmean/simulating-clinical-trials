...
```{r paths-before-trial, echo=FALSE, fig.width=10, fig.height=5}
...
```{r path-during-trial, echo=FALSE, fig.width=10, fig.height=5}
...
```{r post-mortem, fig.width=10, fig.height=5}
path_plot                                        +
