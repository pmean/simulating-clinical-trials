...
Let's keep things simple by forecasting the total number of patients for a trial that is planning to end in 3 years. We are going to use a Bayesian modelling program Stan within R to run our simulation. It's overkill for a simple example like this, but Stan allows you to generalize quickly and easily to a more complex setting.
...
```{r boxplot1, fig.width=7, fig.height=2}
