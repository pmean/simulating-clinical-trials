...
```{r binomial, fig.height=1, fig.width=10}
fit_bi0                                         %>%
  as.data.frame                                 %>%
  mutate(x=" ")                                 -> sim_bi0
...
```{r binomial-extension-during, fig.width=10, fig.height=1}
f <- "7-binomial-extension.stan"
fit_bi4 <- stan(file=f,
...
```{r tm2, fig.width=10, fig.height=1}
prior2_plot  + expand_limits(y=y_range)
...
```{r tm3, fig.width=10, fig.height=1}
prior3_plot  + expand_limits(y=y_range)
