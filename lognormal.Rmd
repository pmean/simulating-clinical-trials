...
The two distributions look identical, except for the tick marks on the X axis.
...
$E[Y] = e^{\mu+{1 \over 2}\sigma^2}$

So this suggests a solution to our problem. Set $\mu$ to $-{1 \over 2}\sigma^2$ instead of 0. 
...
This produces a series of lognormal distributions where the arithmetic mean is 1.0 regardless of how big or how small $\simga$ is.
