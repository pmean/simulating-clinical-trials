...
hedged_prior_plot + expand_limits(y=y_range) -> fig
save(fig, file="fig/5.1a.RData")
simple_prior_plot + expand_limits(y=y_range) -> fig
...
hedged_update1_plot + expand_limits(y=y_range) -> fig
save(fig, file="fig/5.2b.RData")
linear_update1_plot + expand_limits(y=y_range) -> fig
...
simple_update1_plot + expand_limits(y=y_range) -> fig
...
flat_update1_plot   + expand_limits(y=y_range) -> fig
...
hedged_prior_plot   + expand_limits(y=y_range2) -> fig
save(fig, dat_update, dat_update2, file="fig/5.6a.RData")
hedged_update2_plot + expand_limits(y=y_range2) -> fig
save(fig, file="fig/5.6b.RData")
linear_update2_plot + expand_limits(y=y_range2) -> fig
...
simple_prior_plot   + expand_limits(y=y_range2) -> fig
save(fig, file="fig/5.7a.RData")
simple_update2_plot + expand_limits(y=y_range2) -> fig
...
flat_update2_plot   + expand_limits(y=y_range2) -> fig
