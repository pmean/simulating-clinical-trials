...
y_range <- range(sim_hp0$Nstar, sim_gp0$Nstar)
...
### Figure 5.2. Posterior prediction with a hedged prior.

```{r plot-update1, fig.width=7, fig.height=1}
y_range <- range(sim_hp1$Nstar, sim_gp1$Nstar, sim_lp1$Nstar)
...
### Figure 5.2. Updated hedging hyperprior.
