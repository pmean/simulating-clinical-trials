...
On day 192 (finally!) the trial starts accruing patients. The early phase, as expected, was slow, but now you have `r n` patients after `r t` days of active accrual. So how are we doing now?
