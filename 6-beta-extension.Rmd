...
custom_boxplot(sim1, d1_label0a, 0, "black") + expand_limits(y=y_range)
custom_boxplot(sim2, d1_label0b, 0, "red")   + expand_limits(y=y_range)
custom_boxplot(sim3, d1_label0c, 0, "black") + expand_limits(y=y_range)
```
...
custom_boxplot(sim1, d2_label0a, 1, "black") + expand_limits(y=y_range)
custom_boxplot(sim2, d2_label0b, 1, "red")   + expand_limits(y=y_range)
custom_boxplot(sim3, d2_label0c, 1, "black") + expand_limits(y=y_range)
```
...
custom_boxplot(sim1, d3_label0a, 0, "black") + expand_limits(y=y_range)
custom_boxplot(sim2, d3_label0b, 0, "red")   + expand_limits(y=y_range)
custom_boxplot(sim3, d3_label0c, 0, "black") + expand_limits(y=y_range)
```
...
```{r delay_fit0, fig.height=1, fig.width=10}
...
```{r delay_fit1, fig.height=1, fig.width=10}
...
```{r updated_start, fig.width=10, fig.height=1}
sim_dm0                                         %>%
  mutate(y=delta1*T)                            %>%
  mutate(x=" ")                                 %>%
...
```{r remaining_parameters, fig.width=10, fig.height=1}
sim_dm0                                         %>%
...
```{r update_delta3, fig.width=10, fig.height=1}
sim_dm0                                         %>%
  mutate(y=delta3*T)                            %>%
  mutate(x=" ")                                 %>%
...
```{r updated_lambda, fig.width=10, fig.height=1}
sim_dm0                                         %>%
  mutate(y=lambda*30)                           %>%
  mutate(x=" ")                                 %>%
...
```{r delay_fit2, fig.height=1, fig.width=10}
...
```{r shortfall_cause, fig.width=10, fig.height=1}
sim_dm0                                         %>%
  mutate(y=delta1*T)                            %>%
  mutate(x=" ")                                 %>%
  custom_boxplot(d1_label0, 0, co="black")       -> delta10
...
```{r shortfall2, fig.width=10, fig.height=1}
sim_dm0                                         %>%
  mutate(y=delta2*30*N/T)                       %>%
  mutate(x=" ")                                 %>%
  custom_boxplot(d2_label0, 1, co="black")       -> delta20
...
```{r shortfall3, fig.width=10, fig.height=1}
sim_dm0                                         %>%
  mutate(y=delta3*T)                            %>%
  mutate(x=" ")                                 %>%
  custom_boxplot(d3_label0, 0, co="black")       -> delta30
...
```{r shortfall4, fig.width=10, fig.height=1}
sim_dm0                                         %>%
  mutate(y=lambda*30)                           %>%
  mutate(x=" ")                                 %>%
  custom_boxplot(l_label0, 1, co="black")        -> lambda0
