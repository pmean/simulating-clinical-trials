...
r <- T*range(sim_dm0$delta1, sim_dm2$delta1)
sim_dm0                                         %>%
  mutate(y=delta1*T)                            %>%
  mutate(x=" ")                                 %>%
  custom_boxplot(d1_label0, 0, co=color0)        +
  expand_limits(y=r)                            -> fig
...
sim_dm2                                         %>%
  mutate(y=delta1*T)                            %>%
  mutate(x=" ")                                 %>%
  custom_boxplot(d1_label2, 0, co=color1)        +
  expand_limits(y=r)                            -> fig
...
sim_dm1                                         %>%
  mutate(y=delta2*30*N/T)                       %>%
  mutate(x=" ")                                 %>%
  custom_boxplot(d2_label1, 1, co=color0)       -> delta21
sim_dm2                                         %>%
  mutate(y=delta2*30*N/T)                       %>%
  mutate(x=" ")                                 %>%
...
sim_dm1                                         %>%
  mutate(y=delta3*T)                            %>%
  mutate(x=" ")                                 %>%
  custom_boxplot(d3_label1, 0, co=color0)       -> delta31
sim_dm2                                         %>%
  mutate(y=delta3*T)                            %>%
  mutate(x=" ")                                 %>%
...
sim_dm1                                         %>%
  mutate(y=lambda*30)                           %>%
  mutate(x=" ")                                 %>%
  custom_boxplot(l_label1, 1, co=color0)        -> lambda1
sim_dm2                                         %>%
  mutate(y=lambda*30)                           %>%
  mutate(x=" ")                                 %>%
