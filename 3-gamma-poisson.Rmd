...
custom_boxplot(sim1, l_label0a, 1, "black") + expand_limits(y=y_range) -> fig
save(fig, file="fig/3.1a.RData")
custom_boxplot(sim2, l_label0b, 1, "red")   + expand_limits(y=y_range) -> fig
save(fig, file="fig/3.1b.RData")
custom_boxplot(sim3, l_label0c, 1, "black") + expand_limits(y=y_range) -> fig
...
custom_boxplot(sim2, l_label0, 1, co="black") + expand_limits(y=y_range) -> fig
save(fig, file="fig/3.6a.Rdata")
custom_boxplot(sim4, y_label4, 1, co="red")   + expand_limits(y=y_range) -> fig
